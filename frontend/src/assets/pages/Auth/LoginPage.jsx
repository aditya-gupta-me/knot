...
import GlobalGreetings from "../../components/GlobalGreetings";
...
function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await axios.post(`${BACKEND_API_URL}/api/login`, userData, {
      headers: {
